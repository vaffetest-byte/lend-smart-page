        ...
        <div className="flex items-center justify-between h-16 md:h-20 px-4 md:px-8">
          ...
          <a href="#" className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center">
              <span className="text-primary-foreground font-heading font-bold text-lg">LF</span>
            </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            <a href="tel:1-800-123-4567" className="flex items-center gap-2 text-primary font-semibold">
